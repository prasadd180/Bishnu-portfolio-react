...
function Skills() {
  ...
  const metaDescription = `Bishnu Prasad Brahma technical skills include ${technicalSkills.slice(0, 5).map(s => s.name).join(', ')} and more. Professional skills: ${professionalSkills.slice(0, 3).map(s => s.name).join(', ')}.`;
